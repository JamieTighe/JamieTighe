...
Engineering graduate turned data analyst (General Assembly, 12-weeks, full-time). I use **SQL**, **Python**, **Excel** and **Tableau/Power BI** to turn messy real-world data into clean tables, actionable KPIs, and stakeholder-ready dashboards.
